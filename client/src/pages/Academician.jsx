    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-200">
        <div className="container py-6">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Faculty Opportunities</h1>
          <p className="text-sm text-slate-500 mt-1">Fellowships, FDPs, research collaborations & consultancy</p>
        </div>
      </div>
      ...
      <div className="container py-6">
        ...
        {filtered.length === 0 && (
          <div className="card-elevated p-12 text-center">
            <p className="text-slate-500">No opportunities match your search.</p>
          </div>
        )}
      </div>
    </div>
